...
<style>
    ...
    @media (max-width: 576px) {
        /* Reduce page container padding so table uses more screen width */
        .container-fluid {
            padding-left: 8px !important;
            padding-right: 8px !important;
        }

        /* Force all Bootstrap col wrappers to full width */
        ...
        /* Controls row: stacked full-width controls */
        .dataTables_wrapper .row:first-child {
        ...
        /* Card stays at viewport width; only table row scrolls */
        .dataTables_wrapper {
            max-width: 100%;
            overflow-x: hidden;
        }
        ...
        /* Bottom bar: info + pagination each full width, centred */
        .dataTables_wrapper .row:last-child {
            flex-direction: column;
            align-items: stretch;
            gap: 8px;
